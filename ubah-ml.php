...
if (isset($_POST['update-ml'])) {
    $sql = "UPDATE register_ml SET 
    ...
    $sql = mysqli_query($db, "SELECT * FROM register_ml WHERE id='$_GET[kode]'");
...
<head>
    ...
    <title>Update Mobile Legends</title>
                            ...
                            <div class="col">
                                <div class="card-regis">
                                    <div class="card-body">
                                        ...
                                        <form action="ubah-ml.php" method="POST" class="row">
