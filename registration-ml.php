...
if (isset ($_POST["register-ml"])) {
    ...
    $sql = "INSERT INTO `register_ml` (`teamname`, `name1`, `username1`, `id_ml1`, `name2`, `username2`, `id_ml2`, `name3`, `username3`, `id_ml3`, `name4`, `username4`, `id_ml4`, `name5`, `username5`, `id_ml5`, `phone`) VALUES ('$teamname','$name1','$username1','$id_ml1','$name2','$username2','$id_ml2','$name3','$username3','$id_ml3','$name4','$username4','$id_ml4','$name5','$username5','$id_ml5','$phone')";
...
<head>
    ...
    <title>Registration Mobile Legends</title>
                        ...
                        <div class="row align-items-stars">
                            <div class="col">
                                <div class="card-regis">
                                    <div class="card-body">
                                        <h5 class="card-title text-center">Registration Mobile Legends</h5>
                                        <form action="registration-ml.php" method="POST" class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-color"
                                                    name="register-ml">REGISTRATION</button>
